...
#ifndef __DWB_SCRIPT_CALLBACK_H__
#define __DWB_SCRIPT_CALLBACK_H__
...
void 
make_callback(JSContextRef, JSObjectRef, GObject *, const char *, JSValueRef, StopCallbackNotify, JSValueRef *);
